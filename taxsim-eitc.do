...
replace earnincrimp=earnincrimp*cpily // TURNS INCOME INTO NOMINAL DOLLARS
replace earnincsimp=earnincsimp*cpily // TURNS INCOME INTO NOMINAL DOLLARS
replace earnincrsimp=earnincrsimp*cpily // TURNS INCOME INTO NOMINAL DOLLARS
replace unearnincrsimp=unearnincrsimp*cpily // TURNS INCOME INTO NOMINAL DOLLARS
replace nontaxincrsimp=nontaxincrsimp*cpily // TURNS INCOME INTO NOMINAL DOLLARS



***************************************************************************************
gen pretaxinc=earnincrsimp+unearnincrsimp+nontaxincrsimp // ***DEFINES PRETAX INCOME***
***************************************************************************************
...
* THESE ARE THE VARIABLES NEEDED FOR TAXSIM9
***********************************************************************************************************************************************************************************
